    ...
    <div className="md:bg-black/80 bg-black py-36 flex text-center h-full">
      <div className="container mx-auto py-32 text-center xl:text-left flex items-center justify-center h-full">
        <div className="grid max-w-[780px]">
          <h2 className="text-2xl font-semibold pt-16 pb-6 md:h2 xl:mt-20">Get In Touch <span className="text-pink-600">With Me.</span></h2>
          <form className="flex-1 flex flex-col gap-6 w-full mx-auto">
            <div className="flex gap-x-4">
              ...
              <textarea name="" id=""  placeholder="Message" className="bg-transparent border border-white/20 rounded-lg py-3 w-full px-6 focus:border focus:border-green-600 placeholder:text-white/20 pb-20 md:pb-32"></textarea> 
              <button className="btn rounded-full border py-2 border-white/50 max-w-[50%] px-8 transition-all duration-300 flex items-center justify-center overflow-hidden hover:border-pink-600 group">
